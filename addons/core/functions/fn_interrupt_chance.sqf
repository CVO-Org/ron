...
// get unique groups
private _grps = [];
[_pos, east, SET(interruption_enemyPresence_radius)] call FUNC(nearbyUnits) apply { _grps pushBackUnique group _x };
...
private _maxDistance = SET(interruption_enemy_distance);
